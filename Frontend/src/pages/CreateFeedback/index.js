  ...
  return (
    <div>
      ...
      <div style={{ padding: '20px', background: '#fff' }}>
        ...
        <h3 style={{ fontSize: '24px', fontWeight: 'bold',marginLeft:'530px' }}>Provide Your Feedback</h3>
            ...
            <Form
              ...
              style={{ background: '#f0f2f5', padding: '20px', borderRadius: '8px',width: '35%', margin: '0 auto' }}
            >
              <Form.Item
                label="Name"
                name="name"
